...
Cleaning the dataset to remove redundant data.
Training the Machine Learning model and building a rule based algorithm.
A system created by integrating both the Rule Based System and Machine Learning, will flag the transactions into different categories.
Potential fraudulent transactions will be identified.
Whole backend will be integrated with a fontend platform.
User can upload the data of daily transactions and can get potential fraudulent transactions.
Application
